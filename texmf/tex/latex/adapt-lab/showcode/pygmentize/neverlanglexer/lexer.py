...
from typelanglexer.lexer import TypeLangLexer
...
class NeverlangJavaLexer(JavaLexer):
    ...
    # dictionary to pretty print the arrows
    arrows = {':>': u"\u25b6"}

    def get_tokens_unprocessed(self, text):  # redefined to do some magics
        for index, token, value in RegexLexer.get_tokens_unprocessed(self, text):
            if token is Keyword.Pseudo and value in self.arrows.keys():  # This is to transform the arrows (:>) in their pretty version
                yield index, Keyword.Pseudo, self.arrows[value]
            else:
    ...
    tokens = {
        'root': [
            # :> operator
            (r'([^:]+)(:>)', bygroups(using(this), Keyword.Pseudo)),
            # eval
            # commented because it dowsn´t print the final ;
            ...
            (r'(\$\$)', Keyword.Pseudo),
            # $n.attr or #n.attr
            (r'(\#|\$)([\d_-]+)(\.)(\w[\w\d_]+)', bygroups(Keyword.Pseudo, Keyword.Pseudo, Punctuation, Name.Attribute)),
            # $lab[n].attr or #lab[n].attr
            (r'(\#|\$)(\w[\w\d_-]+)(\[)(\d+?)(\])(\.)([\w\d_]+)', bygroups(Keyword.Pseudo, Keyword.Pseudo, Punctuation, Number.Integer, Punctuation, Punctuation, Name.Attribute)),
            # $lab[n] or #lab[n]
            (r'(\#|\$)(\w[\w\d_-]+)(\[)(\d+?)(\])', bygroups(Keyword.Pseudo, Keyword.Pseudo, Punctuation, Number.Integer, Punctuation)),
            # $lab.attr or #lab.attr
            (r'(\#|\$)(\w[\w\d_-]+)(.)([\w\d_]+)', bygroups(Keyword.Pseudo, Keyword.Pseudo, Punctuation, Name.Attribute)),
...
class NeverlangTemplateLexer(JasminLexer):
    ...
    tokens = {
        ...
        'neverlang': [
            ...
            (r'(\$(?:resume|suspend))({0})(;)'.format(comments_or_spaces), bygroups(Keyword.Pseudo, using(this), Punctuation)),
            (r'(\$\$)', Keyword.Pseudo),
            (r'(\#|\$)([\w\d_-]+)(\[)(\d+?)(\])(\.)([\w\d_]+)', bygroups(Keyword.Pseudo, Keyword.Pseudo, Punctuation, Number.Integer, Punctuation, Punctuation, Name.Attribute)),
            (r'(\#|\$)([\w\d_-]+)(\[)(\d+?)(\])', bygroups(Keyword.Pseudo, Keyword.Pseudo, Punctuation, Number.Integer, Punctuation)),
            (r'(\#|\$)([\w\d_-]+)(.)([\w\d_]+)', bygroups(Keyword.Pseudo, Keyword.Pseudo, Punctuation, Name.Attribute)),
            (r'(\#|\$)([\w\d_-]+)', bygroups(Keyword.Pseudo, Keyword.Pseudo)),
            (r'(\#|\$)(\d+?)(\.)([\w\d_]+?)', bygroups(Keyword.Pseudo, Keyword.Pseudo, Punctuation, Name.Attribute)),
            (r'(\$|\#)(\d+?)', bygroups(Keyword.Pseudo, Keyword.Pseudo)),
            (r'//.*?\n', Comment.Single),
...
class NeverlangLexer(RegexLexer):
    ...
    keywords = ('alias', 'as', 'bundle', 'categories', 'concrete', 'decl', 'declare',
                'delegates', 'endemic', 'from', 'imports', 'in-buckets', 'init', 'is',
    ...
    def __init__(self, **option):
        self.sa_languages = {
            ...
            '<typecheck>': TypeLangLexer,
            '<desugar>': NeverlangJavaLexer}
    ...
    def get_tokens_unprocessed(self, text):  # redefined to do some magics
        for index, token, value in RegexLexer.get_tokens_unprocessed(self, text):
            ...
            elif token is Keyword.Pseudo and value in self.arrows.keys():  # This is to transform the arrows (:>) in their pretty version
                yield index, Keyword.Pseudo, self.arrows[value]
    ...
    #   · :> in ▷ (usato nelle azioni semantiche)
    ...
    tokens = {
        ...
        'root': [
            # language
            (r'(language)({0})([^\d\W][\w.-]*)({0})({{)'.format(comments_or_spaces), bygroups(Keyword, using(this), Name.Namespace, using(this), Punctuation), 'language-body'),
            # bundle
            (r'(bundle)({0})([^\d\W][\w.-]*)({0})({{)'.format(comments_or_spaces), bygroups(Keyword, using(this), Name.Namespace, using(this), Punctuation), 'bundle-body'),
        ...
        'slice-body': [
            ...
            (r'(module)({0})([^\d\W][\w.-]*)({0})(with)({0})(role)({0})([^\d\W][\w.-]*)({0})(delegates)({0})({{)'.format(comments_or_spaces), bygroups(Keyword, using(this), Name.Class, using(this), Keyword, using(this), Keyword, using(this), Keyword.Pseudo, using(this), Keyword, using(this), Punctuation), 'delegates-seq'),
        ...
        'delegates-seq': [
            (r'([^\d\W][\w.-]*)({0})(=>)({0})([^\d\W][\w.-]*)({0})(:>)({0})([^\d\W][\w.-]*)(\[)(\d+?)(\])(,)'.format(comments_or_spaces), bygroups(Name, using(this), Operator, using(this), Name, using(this), Keyword.Pseudo, using(this), Keyword.Pseudo, Punctuation, Number.Integer, Punctuation, Punctuation)),
            (r'([^\d\W][\w.-]*)({0})(=>)({0})([^\d\W][\w.-]*)({0})(:>)({0})([^\d\W][\w.-]*)(\[)(\d+?)(\])'.format(comments_or_spaces), bygroups(Name, using(this), Operator, using(this), Name, using(this), Keyword.Pseudo, using(this), Keyword.Pseudo, Punctuation, Number.Integer, Punctuation)),
            (r'(})', Punctuation, '#pop'),
            include('comments and spaces')
        ],
        'reference-body': [
